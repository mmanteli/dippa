...
NHC: 3587642.
NASS: 20 24576261 33.
Domicilio: Paseo de San Francisco, 22.
Localidad/ Provincia: Bilbao.
CP: 20340.
Datos asistenciales.
Fecha de nacimiento: 15/05/1952.
País: España.
Edad: 64  años Sexo: H.
Fecha de Ingreso: 21/12/2016.
Médico: Roberto Llarena Ibarguren  NºCol: 20 20 94583.
...
En la exploración física Guillermo estaba consciente, orientado y colaborador, presentando ptosis palpebral izquierda con salida del ojo del mismo lado, sin soplo aparente, con paresia del III y VI pares izquierdos. Asimismo presentaba alteraciones en la sensibilidad de la mitad derecha de la cara, siendo el resto de la exploración neurológica motora y sensitiva normal.
...
Remitido por: Roberto Llarena Ibarguren Apartado de Correos 20134 48080 Bilbao. (España) rllarena@eusklanet.net
"""
...
print(json.dumps(pd.score_pii(text,"scores/es/bert-es/S0004-06142007000900017-1.txt")))#, debug=True)))
